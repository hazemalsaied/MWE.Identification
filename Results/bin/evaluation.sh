...
for i in $list
        do
            ...
            python3 validate_cupt.py --input /Users/halsaied/PycharmProjects/MWE.Identification/Results/Evaluation/Data/SVM/Corpus/corpus..0.Mar.04.$i.cupt
            python3 evaluate.py --gold /Users/halsaied/PycharmProjects/MWE.Identification/Results/Evaluation/Data/SVM/Corpus/corpus..0.Mar.04.$i.gold.cupt --pred /Users/halsaied/PycharmProjects/MWE.Identification/Results/Evaluation/Data/SVM/Corpus/corpus..0.Mar.04.$i.cupt --train /Users/halsaied/PycharmProjects/MWE.Identification/Results/Evaluation/Data/SVM/Corpus/corpus..0.Mar.04.$i.train.cupt
