...
if __name__ == '__main__':
    ...
    # sys.stdout.write(analyzeCorpus('EN', xpMode=XpMode.linear, dataset=Dataset.dimsum,
    #                     testFileName='/Users/halsaied/PycharmProjects/NNIdenSys/Results/FTB/Linear/EN.dimsum'))
    # sys.stdout.write(analyzeCorpus('FR', xpMode=XpMode.linear, dataset=Dataset.ftb,
